...
docker buildx build --platform linux/amd64,linux/arm64 -t toretto5060/clashandwireguard-config-merger:v1.0.04 -t toretto5060/clashandwireguard-config-merger:latest --push .
